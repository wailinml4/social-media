...
const PostMediaCarousel = ({ images, className = '', onDoubleClick }: PostMediaCarouselProps) => {
  ...
  return (
    <div className={`relative overflow-hidden max-h-[600px] ${className}`} onDoubleClick={onDoubleClick}>
      {isVideo ? (
