...
const Tabs = ({ tabs, activeTab, onTabChange, className = '' }) => {
  ...
  return (
    <div
      className={`p-1.5 bg-bg-dark/40 backdrop-blur-2xl rounded-3xl border border-white/10 flex relative ${className}`}
    >
      ...
      {tabs.map(tab => {
        ...
        return (
          ...
          >
            ...
            <span
              className={`text-[14px] tracking-tight transition-all ${
