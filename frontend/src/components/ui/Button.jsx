...
const Button = ({ children, variant = 'primary', size = 'md', className = '', ...props }) => {
  ...
  const variants = {
    ...
    glass:
      'bg-white/10 text-white hover:bg-white/20 backdrop-blur-md hover:scale-105 focus:ring-white/30 border border-white/10',
    outline:
      'border border-white/20 text-white hover:bg-white/10 hover:scale-105 focus:ring-white/30',
